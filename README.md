...
|Tasfi et al. [[6]](#6)            |2017|iThings, GreenCom, CPSCom, SmartData |Anomaly Detection                                                |Two sub-networks: a convolutional AutoEncoder for the reconstruction of unlabelled data and a classifier for labeled data                |electrical consumption data of buildings                                                                                                                         |no     |univariate           |daily, weekly                              |5 min.                                             |medium-low  |labeled - unspecified real + injected anomalies (increase in usage over time for a small duration in periods with typical low usage)                                              |private                                                                                                                                      |          
...
|Wang et al. [[20]](#20)           |2020|ISGT-Europe                          |1) Anomaly Detection 2) Feature Extraction                       |(1) Vanilla Autoencoder 2) Encoder of Vanilla Autoencoder                                                                                |electricity consumption from 361 buildings of a university campus                                                                                                |yes    |univariate           |weekly                                     |15 min.                                            |low         |labeled - faulty smart meters and unusual consumptions                                                                                                                            |private                                                                                                                                      |          
